...
using SanRafael.Models.AccountViewModels;
...
namespace SanRafael.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            {
                //Quitar estas lineas de código y solo dejar el contenido del IF model.email
                string directorio = Environment.GetEnvironmentVariable("DIRECTORIO");
                string dominio = "";
                if (directorio != null && directorio.Length > 0)
                {
                    dominio = directorio.Substring(1);
                }
                if (!model.Email.Contains(dominio))
                {
