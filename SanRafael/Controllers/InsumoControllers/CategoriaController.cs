...
namespace SanRafael.Controllers.InsumoControllers
{
    ...
    public class CategoriasController : Controller
    {
        ...
        [AcceptVerbs("GET")]
        public ActionResult ExisteCategoria(string Nombre, int Id)
        {
            try
            {
                var categoriaEncontrada = _context.Categoria.FirstOrDefault(m => m.Nombre == Nombre);
                ...
                {
                    var registroEditar = _context.Categoria.FirstOrDefault(x => x.Id == Id);
