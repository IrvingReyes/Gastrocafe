...
namespace SanRafael.Controllers
{
    ...
    public class AreaProduccionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Responsable,Descripcion")] AreaProduccion areaProduccion)
        {
        ...
        [AcceptVerbs("GET")]
        public ActionResult ExisteAreaProduccion(string Nombre, int Id)
        {
            try
            {
                var areaProduccionEncontrada = _context.AreaProduccion.FirstOrDefault(m => m.Nombre == Nombre);
                if (areaProduccionEncontrada == null)
                {
                    return Json(true);
                }
                else
                {
                    var registroEditar = _context.AreaProduccion.FirstOrDefault(x => x.Id == Id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Responsable,Descripcion")] AreaProduccion areaProduccion)
        {
